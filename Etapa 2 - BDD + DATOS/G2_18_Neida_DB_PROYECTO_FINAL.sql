...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2021 a las 17:42:27
...
(1, 1, 78, 'Neida Romero', '54889'),
(2, 2, 32, 'Alejandro Mejía', '1234');
...
--
ALTER TABLE `tbl_cuenta_ahorro`
  MODIFY `ID_CUENTA_AHORRO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_usuarios`
  MODIFY `N_CUENTA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
